...
if __name__ == '__main__':
    ...
    for i in range(0,81):
        ...
        if i == 0: # Prueba 1
            tiempoMD5.append(time.time() - Prueba1MD5)
            Prueba2MD5 = time.time()
        elif i == 10: # Prueba 2
            tiempoMD5.append(time.time() - Prueba2MD5)
            Prueba3MD5 = time.time()
        elif i == 30: # Prueba 3
            tiempoMD5.append(time.time() - Prueba3MD5)
            Prueba4MD5 = Prueba3MD5 = time.time()
        elif i == 80: # Prueba 4
            tiempoMD5.append(time.time() - Prueba4MD5)
    ...
    for i in range(0,81):
        ...
        if i == 0: # Prueba 1
            tiempoSHA1.append(time.time() - Prueba1SHA1)
            Prueba2SHA1 = time.time()
        elif i == 10: # Prueba 2
            tiempoSHA1.append(time.time() - Prueba2SHA1)
            Prueba3SHA1 = time.time()
        elif i == 30: # Prueba 3
            tiempoSHA1.append(time.time() - Prueba3SHA1)
            Prueba4SHA1 = Prueba3SHA1 = time.time()
        elif i == 80: # Prueba 4
            tiempoSHA1.append(time.time() - Prueba4SHA1)
    ...
    for i in range(0,81):
        ...
        if i == 0: # Prueba 1
            tiempoSHA256.append(time.time() - Prueba1SHA256)
            Prueba2SHA256 = time.time()
        elif i == 10: # Prueba 2
            tiempoSHA256.append(time.time() - Prueba2SHA256)
            Prueba3SHA256 = time.time()
        elif i == 30: # Prueba 3
            tiempoSHA256.append(time.time() - Prueba3SHA256)
            Prueba4SHA256 = Prueba3SHA256 = time.time()
        elif i == 80: # Prueba 4
            tiempoSHA256.append(time.time() - Prueba4SHA256)
    ...
    for i in range(0,81):
        Hash.hash(data[i])
        if i == 0: # Prueba 1
            tiempoActividad4.append(time.time() - Prueba1Actividad4)
            Prueba2Actividad4 = time.time()
        elif i == 10: # Prueba 2
            tiempoActividad4.append(time.time() - Prueba2Actividad4)
            Prueba3Actividad4 = time.time()
        elif i == 30: # Prueba 3
            tiempoActividad4.append(time.time() - Prueba3Actividad4)
            Prueba4Actividad4 = Prueba3Actividad4 = time.time()
        elif i == 80: # Prueba 4
            tiempoActividad4.append(time.time() - Prueba4Actividad4)
